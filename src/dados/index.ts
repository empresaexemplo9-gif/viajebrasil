...
export const pacotes: PacoteTurismo[] = [
  ...
  { id: 'p3', categoria: 'turismo', titulo: 'Cataratas do Iguaçu', destino: 'Foz do Iguaçu', uf: 'PR', dias: 3, inclui: ['Aéreo ida e volta', '2 noites de hotel', 'Parque das Cataratas', 'Parque das Aves'], avaliacao: 9.3, totalAvaliacoes: 720, preco: 1390, imagem: imgCommons('Brazil_Cataratas_do_Iguacu_2.JPG'), descricao: 'Uma das sete maravilhas da natureza em um pacote curto e inesquecível.' },
